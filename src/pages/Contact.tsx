...
const schedule: { day: string; hours: string; closed?: boolean }[] = [
  ...
  { day: "Сряда", hours: "09:00 – 21:00" },
  { day: "Четвъртък", hours: "09:00 – 21:00" },
  { day: "Петък", hours: "09:00 – 21:00" },
  { day: "Събота", hours: "09:00 – 21:00" },
  { day: "Неделя", hours: "09:00 – 21:00" },
];
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              <Reveal>
                <h2 className="font-headline text-4xl md:text-5xl mb-12 tracking-tighter uppercase">
                  Establishment <br />
                  Details
                </h2>
              </Reveal>
            ...
            <Reveal direction="right">
              <div className="bg-surface-container-low p-8 md:p-14 border border-outline-variant/10 h-full">
                ...
                <div className="space-y-0">
                  {schedule.map(({ day, hours, closed }, i) => {
                    const today = isToday(day);
                    return (
                      <Reveal key={day} delay={0.1 + i * 0.05}>
                        <div
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-8">
          <motion.div
            ...
            <h1 className="font-headline text-6xl md:text-8xl lg:text-9xl font-light leading-none tracking-tighter uppercase">
              Visit the <span className="italic font-bold text-primary">Palace</span>
            </h1>
          </motion.div>
          ...
          <motion.div
            ...
            <p className="text-on-surface-variant font-body text-xs leading-relaxed uppercase tracking-[0.15em] opacity-80">
              Established on the pillars of excellence, we invite you to experience
              sovereign grooming in the heart of Sofia.
            </p>
          </motion.div>
        </div>
      </div>
